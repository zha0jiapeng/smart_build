...
public class CarGateController {
    ...
    @GetMapping("/test")
    public String test() {
        return hdyHttpUtils.pushPicture("http://10.1.3.202:9000/car-access/a7f5f4f0-1ebe-40c9-9f91-7ed226fdd95f.png");
    }
...
//    }
    ...
    private void pushCarAccess(Map<String, Object> request) {
        ...
        value.put("video_streaming", hdyHttpUtils.pushPicture(imageFile));
